...
return [
   ...
   'cannotSetFilepath'          => '다운로드 에러: 바이너리 설정 중에 파일 경로를 설정할 수 없습니다.', // 'When setting binary cannot set filepath: {0}',
   'notFoundDownloadSource'     => '다운로드 에러: 다운로드 본문 소스를 찾을 수 없음.', // 'Not found download body source.',
   'cannotSetCache'             => '다운로드 에러: 다운로드를 위해, caching을 지원할 수 없습니다.', // 'It does not support caching for downloading.',
   'cannotSetStatusCode'        => '다운로드 에러: 다운로드를 위해, 상태 코드 변경을 지원하지 않습니다. 코드: {0}, 이유: {1}', // 'It does not support change status code for downloading. code: {0}, reason: {1}',
