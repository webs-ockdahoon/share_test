...
return [
   ...
   'writeError'        => '{0} 파일 생성 시도 중에 에러 발생. 디렉터리에 쓰기가 가능한지 확인하십시오.', // 'Error trying to create {0} file, check if the directory is writable.',
   ...
   'rollBackConfirm'   => '롤백(rollback)을 하시겠습니까?', // 'Are you sure you want to rollback?',
   'refreshConfirm'    => '새로 고침(refresh)을 하시겠습니까?', // 'Are you sure you want to refresh?',
