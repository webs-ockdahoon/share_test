...
class DepartmentsModel extends BaseModel
{
    ...
    protected $allowedFields = ['dep_group','dep_title_kor','dep_title_rus','dep_image','dep_sort','dep_content_kor','dep_content_rus',
                                'dep_display_kor','dep_display_rus',
                                'dep_main_display_kor','dep_main_display_rus',
