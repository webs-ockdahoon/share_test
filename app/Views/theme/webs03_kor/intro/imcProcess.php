...
<?php
$this->setVar('bodyClassName', 'page--intro page--intro-imc-process');
$this->setVar('heroTitle', '업무절차');
?>

<?php echo $this->section('appendHead'); ?>
<link rel="stylesheet" href="<?php echo $THEME_URL ?>/css/pages/intro-imc-process.css">
