...
<div class="container section mt-0">
    ...
    <div class="section-divider">
        <ul class="nav nav-tabs--v1 nav-tabs--v1-secondary justify-content-center text-center" id="convenienceTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" href="/kor/medical/departmentInfo/<?php echo $dep_idx; ?>" aria-selected="true">
                    진료과 소개
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" href="/kor/medical/doctor/<?php echo $dep_idx; ?>" aria-selected="false">
                    의료진 소개
                </a>
            </li>
        </ul>
    ...
    <div class="section-box text-right">
        <a href="/kor/medical/department" class="btn btn-lg btn-wide btn-outline-light text-gray--dark border">전체 진료과</a>
    </div>
