    ...
    <div class="section-divider">
        <ul class="nav nav-tabs--v1 nav-tabs--v1-secondary justify-content-center text-center" id="convenienceTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link" href="/kor/center/departmentInfo/<?php echo $dep_idx; ?>" aria-selected="true">
                    전문센터 소개
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link active" href="/kor/center/doctor/<?php echo $dep_idx; ?>" aria-selected="false">
                    의료진 소개
                </a>
            </li>
        </ul>
