...
<?php
    ...
    $this->setVar('heroTitle', $people_list[0]['mes_medical_type']);
?>
...
<div class="container section mt-0">
    ...
    <div class="section-divider">
        <ul class="nav nav-tabs--v1 nav-tabs--v1-secondary justify-content-center text-center" id="convenienceTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link" href="/kor/center/specializedInfo?title=<?php echo $_GET['title']; ?>" aria-selected="false">
                    진료과 소개
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link active" href="/kor/center/specializedDoctors?title=<?php echo $_GET['title']; ?>" aria-selected="true">
                    의료진 소개
                </a>
            </li>
        </ul>
    ...
    <div class="section-box section-text">
        ...
        <ul class="list-unstyled row row-sm mb-n4">
            <?php foreach ($people_list as $key => $val){ ?>
                <li class="col-12 col-lg-6 mb-4">
                    <section class="card doctor-card">
                        <div class="card-thumbnail-body">
                            <div class="card-thumbnail">
                                <!-- // image size: 96px x 128px (3:4) -->
                                <span class="card-thumbnail__img bg-light rounded" style="background-image: url('/uploaded/file/<?php echo $val["mes_image"]?>');"></span>
                            </div>
                            <div class="card-body">
                                <h4 class="card-title"><?php echo $val['mes_name']; ?></h4>
                                <dl class="data-table data-table--responsive-lg mb-0">
                                    <div class="data-table__row">
                                        <dt class="data-table__row-label text-primary">진료과</dt>
                                        <dd class="data-table__row-text"><?php echo $val['mes_medical_type']; ?></dd>
                                    </div>
                                    <div class="data-table__row">
                                        <dt class="data-table__row-label text-primary">전문 진료분야</dt>
                                        <dd class="data-table__row-text">
                                            <div class="text-truncate--multiple"><?php echo $val['mes_content']; ?></div>
                                        </dd>
                                    </div>
                                </dl>
                            </div>
                        ...
                        <a href="/kor/center/centerDoctor?doctors=<?php echo $val['mes_idx']; ?>" class="card-action">의료진 정보</a>
                    </section>
                </li>
            <?php } ?>
        </ul>
    ...
    <div class="section-box text-right">
        <a href="/kor/center/specializedCenter" class="btn btn-lg btn-wide btn-outline-gray text-gray--dark  border">전체 진료과</a>
    </div>
</div>
<?php echo $this->endSection(); ?>
