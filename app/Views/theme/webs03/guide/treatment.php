...
<?php echo $this->section('appendHead'); ?>
    <link rel="stylesheet" href="<?php echo $THEME_URL ?>/css/pages/guide-treatment.css">
...
<?php echo $this->section('content'); ?>
    ...
    <section class="container section">
        ...
        <div class="section-body text-muted">
            <h4 class="section-subtitle">1. 처음 오신분(초진)</h4>
            <ol class="list-unstyled">
                <li>
                    <h5><span class="text-uppercase text-primary">step 01</span>1층 고객지원센터</h5>
                    <p>
                ...
                <li>
                    <h5>step 04<br>검사/촬영/주사/투약</h5>
                    <p>
                        수납영수증에 표시된 해당부서로 가서 검사/촬영/주사실에 접수하면 됩니다. 처방전 발행은 외래원무과
                        수납창구에서 원내투약은 본관 1층 약제국에서 받으십시오.
                    </p>
                </li>
                <li>
                    <h5>step 05<br>귀가</h5>
                    <p>
                        다음 진료가 필요한 경우 진료비 계산시 미리 예약을 해두시거나 전화예약(051-240-2400 ~ 1)을 이용하시면
                        편리합니다.
                    </p>
                </li>
            </ol>
