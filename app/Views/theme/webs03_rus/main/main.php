                ...
                <div class="swiper-wrapper">
                    ...
                    <?php foreach($main_dep_list as $dep_item){
                        ...
                        <div class="swiper-slide">
                            <div>
                                <a href="/<?php echo $link?>/departmentInfo/<?php echo $dep_item['dep_idx']?>" class="card service-card">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <section class="member-card">
                        ...
                        <p class="member-modal-sub-title text-primary">department</p>
        ...
        <div class="container">
            <div class="section-content">
                ...
                <ul class="list-unstyled mb-0 news-cards">
                    ...
                    if(isset($bod_list['news']['article'])){
                        foreach($bod_list['news']['article'] as $bod):
                            ...
                            <li class="card news-card">
                                ...
                                <div class="card-body">
                                    <h3 class="card-title text-truncate text-dark">
                                        <a href="/board/news/read/<?php echo $bod['bod_idx']?>"><?php echo $bod['bod_title']?></a>
                                    </h3>
