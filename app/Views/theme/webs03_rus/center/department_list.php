                ...
                <li>
                    <section class="medical-card medical-card--focusable text-center" tabindex="0">
                        ...
                        <div class="card-content card-hover-content bg-secondary">
                            ...
                            <a href="/center/departmentInfo/<?php echo $department['dep_idx']; ?>" class="btn btn-block btn-outline-gray card-btn" tabindex="0">состав</a>
                            <a href="/center/doctor/<?php echo $department['dep_idx']; ?>" class="btn btn-block btn-outline-gray card-btn" tabindex="0">врачебный</a>
                        </div>
                    </section>
                </li>
            <?php endforeach; ?>
