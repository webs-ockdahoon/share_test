        ...
        <div class="section-divider">
            <ul class="nav nav-tabs--v1 nav-tabs--v1-secondary justify-content-center text-center" id="convenienceTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" href="/medical/departmentInfo/<?php echo $dep_idx; ?>" aria-selected="true">
                        Отделения
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" href="/medical/doctor/<?php echo $dep_idx; ?>" aria-selected="false">
                        врачебный
                    </a>
                </li>
            </ul>
