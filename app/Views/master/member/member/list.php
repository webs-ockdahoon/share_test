                ...
                <div class="grid simple ">
                    ...
                    <div class="grid-body ">
                        <div class="row-fluid">
                            ...
                            <span class='label label-default'>S</span> : 일반가입  / <span class='label label-warning'>K</span> : 카카오 로그인 / <span class='label label-success'>N</span> : 네이버 로그인
                            <table class="table table-bordered no-more-tables">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row["mem_created_at"]?></td>
                                        <td class='listBtn'>
