                            ...
                            <form>
                                ...
                                <div class="col-sm-6 col-md-3 col-lg-2">
                                    <div class="form-group">
                                        <label class="form-label ">전문센터명</label>
                                        <div class="controls">
                                ...
                                <?php if ($total_count>0){
                                    foreach($list as $row){ ?>
                                        <tr>
                                            ...
                                            <td><img src="/uploaded/file/<?php echo $row["mes_image"]?>" class="h80" onerror="this.src='/uploaded/file/noimage.jpg'"></td>
                                            <td><?php echo $row["mes_medical_type"]?></td>
                                            <td><?php echo $row["mes_name"]?></td>
                                            <td><?php echo $row["mes_created_at"]?></td>
                                            <td><?php echo $row["mes_state"]?></td>
